...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../../todo-laravel/node_modules/webpack/buildin/global.js */ "./node_modules/webpack/buildin/global.js"), __webpack_require__(/*! ./../../../todo-laravel/node_modules/timers-browserify/main.js */ "./node_modules/timers-browserify/main.js").setImmediate))
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    addTodo: function addTodo(categorie_id) {
      var _this5 = this;

      var val = document.getElementById(categorie_id).value;
      fetch("api/todo/".concat(categorie_id, "/").concat(val), {
        method: 'post',
        ...
        _this5.clearInput(categorie_id);
    ...
    clearInput: function clearInput(categorie_id) {
  ...
  return _c("div", [
    ...
    _c(
      ...
      _vm._l(_vm.categories, function(categorie) {
        return _c(
          "section",
          { key: categorie.id, staticClass: "col-sm-6 col-md-4" },
          [
            _c(
              "div",
              { staticClass: "card", staticStyle: { "margin-bottom": "2rem" } },
              [
                _c("div", { staticClass: "card-header align-items-center" }, [
                  _c("h3", [
                    ...
                    _c(
                      "span",
                      {
                        staticStyle: { "font-size": "24px", color: "#FF3547" },
                        on: {
                          click: function($event) {
                            _vm.deleteCategorie(categorie.id)
                          }
                        }
                      },
                  ...
                  _c("input", {
                    ...
                    on: {
                      keyup: function($event) {
                        ...
                        _vm.addTodo(categorie.id)
                      }
                    }
                  })
                ]),
                _vm._v(" "),
                _vm._l(categorie.todos, function(todo) {
                  return _c(
                    "ul",
                    {
                      key: todo.id,
  ...
  function() {
    ...
    return _c("div", { staticClass: "col-auto" }, [
      _c(
        "button",
        {
          staticClass: "btn btn-primary btn-md mt-0",
          attrs: { type: "submit" }
        },
        [_vm._v("Add")]
      )
...
Vue.component('todos', __webpack_require__(/*! ./components/Todos.vue */ "./resources/js/components/Todos.vue")["default"]); // eslint-disable-next-line no-new
...
__webpack_require__(/*! /var/www/html/todo-laravel/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /var/www/html/todo-laravel/resources/sass/app.scss */"./resources/sass/app.scss");
